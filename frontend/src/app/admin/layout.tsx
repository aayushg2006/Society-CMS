...
const menuItems = {
  main: [
    ...
    { href: '/admin/buildings', label: 'Buildings & Flats', icon: '🏢' },
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (!isLoading) {
      if (!user) {
        router.push('/login');
      } else if (user.role !== 'ADMIN' && user.role !== 'SECRETARY' && user.role !== 'SUPER_ADMIN') {
  ...
  return (
    <div className="page-container portal-admin">
      {/* Sidebar */}
