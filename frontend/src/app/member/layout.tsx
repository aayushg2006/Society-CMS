...
const menuItems = {
  main: [
    ...
    { href: '/member/complaints/my', label: 'My Complaints', icon: '📝' },
    { href: '/member/complaints/new', label: 'File Complaint', icon: '✏️' },
    { href: '/member/complaints', label: 'Society Complaints', icon: '📋' },
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="page-container portal-member">
      {/* Sidebar */}
