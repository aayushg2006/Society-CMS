          ...
          <div className="glass-card animate-fade-in-up" style={{ padding: 28 }}>
            ...
            {complaint.imageUrl && (
              <div style={{ marginBottom: 16, borderRadius: 'var(--radius-md)', overflow: 'hidden' }}>
                <div style={{ fontSize: 12, color: 'var(--text-muted)', marginBottom: 8, textTransform: 'uppercase' }}>Your Attachment</div>
            ...
            {(complaint.vendorBeforeImageUrl || complaint.vendorAfterImageUrl) && (
              <div style={{ marginBottom: 24 }}>
                <h4 style={{ fontSize: 14, fontWeight: 700, marginBottom: 12, paddingBottom: 8, borderBottom: '1px solid var(--border-glass)' }}>Resolution Images</h4>
